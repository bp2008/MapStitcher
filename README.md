...
The default map source is Google Maps' satellite imagery, but should in theory be compatible with any map server which shares a similar API and uses the Mercator projection.
